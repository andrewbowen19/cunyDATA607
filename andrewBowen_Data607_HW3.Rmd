...
## Question 1
Using [FiveThirtyEight's College major list](https://raw.githubusercontent.com/fivethirtyeight/data/master/college-majors/majors-list.csv)
```{r}
...
str_view(test_str, "([a-zA-Z]{1})\\1\\1")
```
