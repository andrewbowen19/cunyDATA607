...
## Question 1
Using [FiveThirtyEight's College major list](https://raw.githubusercontent.com/fivethirtyeight/data/master/college-majors/majors-list.csv) csv file, pulling the datainto our `majors` dataframe straight from GitHub for reproducability.
```{r}
